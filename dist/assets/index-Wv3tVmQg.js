...
function ka(e, n, t) {
  return zn & 21
    ? (Oe(t, n) || ((t = Ns()), (V.lanes |= t), (Tn |= t), (e.baseState = !0)),
      n)
...
function Ha(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = qr(e, r);
    ...
    j |= 2;
    var o = Qa();
    (J !== e || b !== n) && ((Ve = null), (lt = Q() + 500), Cn(e, n));
    do
      try {
        yd();
        break;
...
function Pd(e, n, t, r, l) {
  ...
  var s = Ti(e, 0, !1, null, null, !1, !1, "", Au);
  return (
...
const Rd = (e) => {
    const { name: n, imgUrl: t, species: r } = e;
    return R.jsxs("div", {
      className: "card",
      children: [
        R.jsx("div", {
  ...
  jd = "/assets/icons8-rick-and-morty-Dz_hke6K.svg",
  Od = () => {
    const [e, n] = Ie.useState([]),
      [t, r] = Ie.useState(""),
      [l, o] = Ie.useState(""),
      [i, u] = Ie.useState(!1),
      s = R.jsx("div", { children: jd });
    Ie.useEffect(() => {
      if (i) throw new Error("Test for ErrorBoundary");
      c();
    }, [l, i]);
    const c = () => {
        const m = localStorage.getItem("searchTerm");
        m ||
          ...
          m &&
            (o(m),
            fetch(`https://rickandmortyapi.com/api/character/?name=${m}`)
              .then((p) => p.json())
              .then((p) => {
                n(p.results);
              })
    ...
    return R.jsxs("main", {
      ...
      children: [
                ...
                children: [
                  ...
                  R.jsx("button", {
                    ...
                    onClick: (m) => {
                      m.preventDefault(),
                        o(t),
                        localStorage.setItem("searchTerm", t),
                        c();
                    },
                  }),
                ],
        ...
        R.jsx("h2", {
          className: "message",
          children: "Find your favorite character!",
        }),
        s &&
          R.jsx("section", {
            ...
            children: R.jsx("div", {
              ...
              children: e.map((m) =>
                R.jsx(
                  Rd,
                  { imgUrl: m.image, name: m.name, species: m.species },
                  m.id,
                ),
              ),
            }),
  ...
  Dd = "ErrorBoundary has detected an error!";
class Id extends Ie.Component {
  refreshWindow() {
  ...
  render() {
    return R.jsxs("div", {
      children: [
        R.jsx("h1", { className: "heading", children: Dd }),
        R.jsx("button", {
          className: "refresh",
...
function Ud() {
  return R.jsxs("div", {
    ...
    children: [
      R.jsx(Md, {}),
      R.jsx(Fd, { fallback: R.jsx(Id, {}), children: R.jsx(Od, {}) }),
    ],
  });
}
Ql.createRoot(document.getElementById("root")).render(
  R.jsx(gc.StrictMode, { children: R.jsx(Ud, {}) }),
);
