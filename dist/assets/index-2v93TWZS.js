...
function je(e, n, t, r) {
  ...
  Gt(e, t, r),
    (!(j & 2) || e !== J) &&
      (e === J && (!(j & 2) && (cl |= t), X === 4 && en(e, b)),
      pe(e, r),
      t === 1 && j === 0 && !(n.mode & 1) && ((lt = Q() + 500), il && vn()));
}
function pe(e, n) {
...
function Ln(e) {
  ...
  try {
    ...
    (O = r), (xe.transition = t), (j = n), !(j & 6) && vn();
  }
}
function Ni() {
  (me = Qn.current), I(Qn);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Jo(n, t | 1), pe(n, Q()), !(j & 6) && ((lt = Q() + 500), vn()));
      }
      break;
    case 13:
      Ln(function () {
...
class Rd extends Oe.Component {
  constructor(n) {
    super(n);
  }
  render() {
    const { name: n, imgUrl: t, species: r } = this.props;
    return R.jsxs("div", {
      className: "card",
      children: [
        R.jsx("div", {
        ...
        R.jsxs("div", {
          ...
          children: [
            R.jsx("h3", { className: "character-name", children: n }),
            R.jsx("table", {
              ...
              children: R.jsx("tbody", {
                children: R.jsxs("tr", {
                  children: [
                    ...
                    R.jsx("td", {
                      className: "character-details__value",
                      children: r,
                    }),
                  ],
                }),
...
class jd extends Oe.Component {
  constructor(n) {
    super(n),
      ...
      (this.state = {
        ...
        showError: !1,
        inputRef: Oe.createRef(),
      });
  }
  fetchData() {
    const n = localStorage.getItem("searchTerm");
    n ||
      fetch("https://rickandmortyapi.com/api/character")
        .then((t) => t.json())
        .then((t) => {
          this.setState({ characters: t.results });
        })
        .catch((t) => {
          console.error(t), this.setState({ loading: "" });
        }),
      n &&
        (this.setState({ searchTerm: n }),
        fetch(`https://rickandmortyapi.com/api/character/?name=${n}`)
          .then((t) => t.json())
          .then((t) => {
            this.setState({ characters: t.results });
          })
  ...
  render() {
    const {
      ...
      u = R.jsx("div", { children: r });
    if (o) throw new Error("Test for error Boundary");
    return R.jsxs("main", {
      className: "main",
      children: [
        R.jsxs("section", {
              ...
              children: R.jsxs("form", {
                ...
                children: [
                  ...
                  R.jsx("button", {
                    ...
                    onClick: (s) => {
                      s.preventDefault(),
                        this.setState({ searchTerm: i.current.value }),
                        localStorage.setItem("searchTerm", i.current.value),
                        this.fetchData();
                    },
                  }),
                ],
        ...
        R.jsx("h2", { className: "message", children: l }),
        u &&
          R.jsx("section", {
            ...
            children: R.jsx("div", {
              ...
              children: n.map((s) =>
                R.jsx(
                  Rd,
                  { imgUrl: s.image, name: s.name, species: s.species },
                  s.id,
                ),
              ),
            }),
...
class Od extends Oe.Component {
  ...
  render() {
    return R.jsx("header", {
      className: "header",
      children: R.jsx("h1", { className: "logo", children: "Rick and Morty" }),
    });
  }
}
class Md extends Oe.Component {
  render() {
    return R.jsxs("div", {
      className: "main-layout",
      children: [R.jsx(Od, {}), R.jsx(jd, {})],
    });
  }
}
class Dd extends Oe.Component {
  render() {
    return R.jsx(Md, {});
  }
}
class Id extends Oe.Component {
  constructor(n) {
    super(n), (this.state = { hasError: !1 });
  }
  ...
  componentDidCatch(n, t) {
    console.error("Error caught:", n, t);
  }
  render() {
    return this.state.hasError ? this.props.fallback : this.props.children;
  }
}
const Fd = "ErrorBoundary has detected an error!";
class Ud extends Oe.Component {
  refreshWindow() {
  ...
  render() {
    return R.jsxs("div", {
      children: [
        R.jsx("h1", { className: "heading", children: Fd }),
        R.jsx("button", {
          className: "refresh",
          onClick: this.refreshWindow,
          children: "To return, click on this button",
        }),
      ],
    });
  }
...
Ql.createRoot(document.getElementById("root")).render(
  R.jsx(gc.StrictMode, {
    children: R.jsx(Id, { fallback: R.jsx(Ud, {}), children: R.jsx(Dd, {}) }),
  }),
);
